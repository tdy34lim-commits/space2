...
SEASON_COLORS = {"봄": "#2ca25f", "여름": "#e31a1c", "가을": "#FFFF00", "겨울": "#3182bd"}
    ...
    if fire_stations is not None:
        ...
        fig.add_trace(
            go.Scattermapbox(
                ...
                mode="markers",
                marker={"size": 8, "symbol": "square", "color": "#111111", "opacity": 0.85},
                text=fire_stations["소방서명"],
        ...
        annotations=[
            {
                ...
                "text": (
                    ...
                    "<span style='color:#FFFF00'>●</span> 가을&nbsp;&nbsp;"
